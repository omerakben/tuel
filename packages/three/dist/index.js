...
import { Environment, ContactShadows, OrbitControls, Float, MeshDistortMaterial, PerspectiveCamera, Preload, MeshWobbleMaterial } from '@react-three/drei';
...
function R3FCanvas(_a) {
  ...
  return /* @__PURE__ */ React.createElement(ClientOnly, { fallback }, /* @__PURE__ */ React.createElement(Canvas, __spreadValues({}, canvasProps), /* @__PURE__ */ React.createElement(Suspense, { fallback: null }, children)));
}
...
function FloatingObjects({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: cn("w-full h-full", className) }, /* @__PURE__ */ React.createElement(
    Canvas,
    {
      shadows,
    ...
    environment && /* @__PURE__ */ React.createElement(Environment, { preset: environment }),
...
function OrbitSceneContent({
  ...
  ), /* @__PURE__ */ React.createElement(Environment, { preset: environment }), /* @__PURE__ */ React.createElement("ambientLight", { intensity: 0.5 }), /* @__PURE__ */ React.createElement(
    "directionalLight",
    {
      position: [10, 10, 5],
      intensity: 1,
  ...
  ), /* @__PURE__ */ React.createElement(Suspense, { fallback: null }, /* @__PURE__ */ React.createElement("group", { ref: groupRef }, children)), /* @__PURE__ */ React.createElement(Preload, { all: true }));
}
function ThreeOrbitScene(_a) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: cn("relative w-full h-full", className) }, /* @__PURE__ */ React.createElement(ClientOnly, { fallback }, /* @__PURE__ */ React.createElement(OrbitSceneContent, __spreadValues({}, props))));
}
...
export { ClientOnly, ExampleOrbitBox, FloatingObjects, MorphingShapes, R3FCanvas, ThreeOrbitScene };
