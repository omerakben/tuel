...
function WodniackWorkScroll({
  ...
  return /* @__PURE__ */ jsx("div", { className: `wodniack-work-scroll ${className || ""}`, children: enableSmoothScroll ? /* @__PURE__ */ jsx(ReactLenis, { root: true, options: lenisOptions, children: /* @__PURE__ */ jsx(
...
function WodniackWorkScrollContent({
  ...
  const cardsCanvasRef = useRef(null);
  const lettersSceneRef = useRef(null);
  const cardsSceneRef = useRef(null);
  const lettersCameraRef = useRef(null);
  const cardsCameraRef = useRef(null);
  const lettersRendererRef = useRef(null);
  const cardsRendererRef = useRef(null);
  const pathsRef = useRef([]);
  const cardsTextureRef = useRef(null);
  ...
  const lerp = useCallback((start, end, t) => {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      ref: containerRef,
      children: [
        /* @__PURE__ */ jsx("section", { className: "wodniack-intro", children: /* @__PURE__ */ jsx("h1", { children: introText }) }),
        /* @__PURE__ */ jsxs("section", { className: "wodniack-work", ref: workRef, children: [
          /* @__PURE__ */ jsx("canvas", { ref: gridCanvasRef, className: "wodniack-grid-canvas" }),
          /* @__PURE__ */ jsx("div", { ref: textContainerRef, className: "wodniack-text-container" })
        ] }),
        /* @__PURE__ */ jsx("section", { className: "wodniack-outro", children: /* @__PURE__ */ jsx("h1", { children: outroText }) }),
        !isReady && /* @__PURE__ */ jsx("div", { className: "wodniack-loading", children: /* @__PURE__ */ jsx("p", { children: "Loading..." }) })
      ]
    }
  );
}
...
function HorizontalScroll({
  ...
  useEffect2(() => {
    ...
    const animation = gsap2.to(scrollElement, {
  ...
  return /* @__PURE__ */ jsx2(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx2("div", { ref: scrollRef, className: cn("flex w-fit", className), children })
    }
  );
}
function HorizontalScrollItem({
  ...
  return /* @__PURE__ */ jsx2("div", { className: cn("flex-shrink-0", className), "data-width": width, children });
}
...
function OrchestraCubes({
  ...
  const stickyRef = useRef3(null);
  const logoRef = useRef3(null);
  const cubesRef = useRef3(null);
  const header1Ref = useRef3(null);
  const header2Ref = useRef3(null);
  const [cubeRefs] = useState2(() => {
    const refs = {};
  ...
  useEffect3(() => {
    ...
    const scrollTrigger = ScrollTrigger3.create({
  ...
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    /* @__PURE__ */ jsxs2(
      "div",
      {
        ...
        children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs2("div", { className: "flex flex-col gap-2", children: [
                  /* @__PURE__ */ jsx3("div", { className: "w-4 h-4 bg-[#ffe9d9]" }),
                  /* @__PURE__ */ jsx3("div", { className: "w-4 h-4 bg-[#ffe9d9]" })
                ] }),
                /* @__PURE__ */ jsxs2("div", { className: "flex flex-col gap-2", children: [
                  /* @__PURE__ */ jsx3("div", { className: "w-4 h-4 bg-[#ffe9d9]" }),
          ...
          /* @__PURE__ */ jsx3("div", { ref: cubesRef, className: "cubes-container opacity-0", children: Object.keys(cubesData).map((cubeKey, index) => /* @__PURE__ */ jsx3("div", { ref: cubeRefs[cubeKey], children: /* @__PURE__ */ jsx3(Cube, { cubeKey, images: cubeImages[index] }) }, cubeKey)) }),
          /* @__PURE__ */ jsx3(
            "div",
            {
              ref: header1Ref,
              className: "absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-10 max-w-4xl px-8",
              children: /* @__PURE__ */ jsx3("h1", { className: "text-4xl md:text-6xl font-bold leading-tight text-[#ffe9d9]", children: header1 })
            }
          ),
          /* @__PURE__ */ jsxs2(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx3("h2", { className: "text-3xl md:text-5xl font-bold mb-6 text-[#ffe9d9]", children: header2 }),
                /* @__PURE__ */ jsx3("p", { className: "text-lg md:text-xl leading-relaxed text-[#ffe9d9]", children: subtitle })
              ]
            }
          )
        ]
    ...
    /* @__PURE__ */ jsx3("section", { className: "relative w-full h-screen flex justify-center items-center text-center bg-[#cdb9ab] text-[#331707]", children: /* @__PURE__ */ jsx3("h2", { className: "text-3xl md:text-5xl font-bold", children: "Your next section goes here" }) })
  ] });
}

// src/components/OrkenWorldScroll.tsx
import { gsap as gsap4 } from "gsap";
import { ScrollTrigger as ScrollTrigger4 } from "gsap/ScrollTrigger";
import { useEffect as useEffect4, useRef as useRef4 } from "react";
import { jsx as jsx4, jsxs as jsxs3 } from "react/jsx-runtime";
if (typeof window !== "undefined") {
  gsap4.registerPlugin(ScrollTrigger4);
}
var defaultCards = [
  {
    id: 1,
...
function OrkenWorldScroll({ className = "" }) {
  const stickyRef = useRef4(null);
  const outlineCanvasRef = useRef4(null);
  const fillCanvasRef = useRef4(null);
  const cardsRef = useRef4(null);
  const triangleStatesRef = useRef4(/* @__PURE__ */ new Map());
  const animationFrameIdRef = useRef4(null);
  const canvasXPositionRef = useRef4(0);
  ...
  useEffect4(() => {
    ...
    const scrollTrigger = ScrollTrigger4.create({
  ...
  return /* @__PURE__ */ jsxs3(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx4("section", { className: "relative w-screen h-screen overflow-hidden flex justify-center items-center bg-black text-white", children: /* @__PURE__ */ jsxs3("h1", { className: "text-center text-4xl md:text-6xl lg:text-[80px] uppercase font-light leading-none", children: [
          /* @__PURE__ */ jsx4("span", { className: "text-orange-500", children: "Enter a Universe" }),
        ...
        /* @__PURE__ */ jsxs3(
          "section",
          {
            ...
            children: [
              /* @__PURE__ */ jsx4("div", { className: "absolute inset-0 w-full h-full bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" }),
              /* @__PURE__ */ jsx4(
                "canvas",
                {
              ...
              /* @__PURE__ */ jsx4(
                "div",
                {
                  ...
                  children: defaultCards.map((card) => /* @__PURE__ */ jsxs3(
                    "div",
                    {
                      className: "relative w-[10%] h-[75%] bg-black rounded-xl overflow-hidden flex flex-col",
                      children: [
                        /* @__PURE__ */ jsx4("div", { className: "flex-1 w-full", children: /* @__PURE__ */ jsx4(
                          "img",
                          {
                            src: card.image,
                            alt: card.title,
                        ...
                        /* @__PURE__ */ jsxs3("div", { className: "absolute bottom-5 left-5 text-white", children: [
                          /* @__PURE__ */ jsx4("h1", { className: "text-2xl mb-1 font-light uppercase", children: card.title }),
                          /* @__PURE__ */ jsx4("p", { className: "text-sm opacity-70 font-medium", children: card.productCode })
                        ] })
                      ]
                    },
                    card.id
        ...
        /* @__PURE__ */ jsx4("section", { className: "relative w-screen h-screen overflow-hidden flex justify-center items-center bg-black text-white", children: /* @__PURE__ */ jsxs3("h1", { className: "text-center text-4xl md:text-6xl lg:text-[80px] uppercase font-light leading-none", children: [
          "Chase the ",
          /* @__PURE__ */ jsx4("span", { className: "text-orange-500", children: "shadows" }),
...
function ParallaxScroll({
  ...
  return /* @__PURE__ */ jsx5(
    motion.div,
    {
      ref,
      style: transforms,
      className: cn2("will-change-transform", className),
      children
    }
  );
}
...
function ParallaxContainer({
  ...
  return /* @__PURE__ */ jsx5("div", { className: cn2("relative overflow-hidden", className), children });
}

// src/components/RadgaHorizontalScroll.tsx
import { gsap as gsap5 } from "gsap";
import { ScrollTrigger as ScrollTrigger5 } from "gsap/ScrollTrigger";
...
function RadgaHorizontalScroll({
  ...
  const stickyRef = useRef6(null);
  const slidesContainerRef = useRef6(null);
  const sliderRef = useRef6(null);
  const slideRefs = useRef6([]);
  const currentVisibleIndexRef = useRef6(null);
  const observerRef = useRef6(null);
  useEffect5(() => {
    if (!stickyRef.current || !slidesContainerRef.current || !sliderRef.current)
      return;
    if (typeof window !== "undefined") {
      gsap5.registerPlugin(ScrollTrigger5);
    }
    const stickySection = stickyRef.current;
    ...
    const scrollTrigger = ScrollTrigger5.create({
      trigger: stickySection,
      start: "top top",
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ jsx6(
                  "div",
                  {
                    ...
                    children: slides.map((slide, index) => /* @__PURE__ */ jsxs4(
                      "div",
                      {
                        ref: (el) => {
                            ...
                            "div",
                            {
                              ...
                              children: /* @__PURE__ */ jsxs4(
                                "h1",
                                {
                                  ...
                                  children: [
                                    slide.title,
                                    slide.subtitle && /* @__PURE__ */ jsxs4(Fragment2, { children: [
                                      /* @__PURE__ */ jsx6("br", {}),
                                      slide.subtitle
                                    ] })
                                  ]
...
import { cn as cn3, isClient } from "@tuel/utils";
import { gsap as gsap6 } from "gsap";
import { ScrollTrigger as ScrollTrigger6 } from "gsap/ScrollTrigger";
import { useEffect as useEffect6, useRef as useRef7 } from "react";
import { jsx as jsx7, jsxs as jsxs5 } from "react/jsx-runtime";
if (isClient) {
  gsap6.registerPlugin(ScrollTrigger6);
}
function ScrollFrameAnimation({
  ...
  const contextRef = useRef7(null);
  const imagesRef = useRef7([]);
  const frameRef = useRef7({ current: 0 });
  const isLoadedRef = useRef7(false);
  useEffect6(() => {
  ...
  if (!isClient) {
    return /* @__PURE__ */ jsx7("div", { className, children: fallback });
  }
  return /* @__PURE__ */ jsxs5("div", { ref: containerRef, className: cn3("relative", className), children: [
    /* @__PURE__ */ jsx7(
      "canvas",
      {
        ref: canvasRef,
...
import { useEffect as useEffect7, useRef as useRef8, useState as useState3 } from "react";
...
function ScrollMinimap({
  ...
  const itemsRef = useRef8(null);
  const indicatorRef = useRef8(null);
  const previewImageRef = useRef8(null);
  const itemRefs = useRef8([]);
  const animationFrameRef = useRef8(null);
  const translateRef = useRef8({
    current: 0,
    target: 0,
    max: 0
  });
  const [isHorizontal, setIsHorizontal] = useState3(false);
  const [currentImageIndex, setCurrentImageIndex] = useState3(0);
  const dimensionsRef = useRef8({
    itemSize: 0,
    containerSize: 0,
    indicatorSize: 0
  });
  const isClickMoveRef = useRef8(false);
  ...
  return /* @__PURE__ */ jsxs6(
    "div",
    {
      className: cn4("scroll-minimap-container", className),
      ref: containerRef,
      children: [
        /* @__PURE__ */ jsxs6("div", { className: "minimap", style: { position: "relative" }, children: [
          /* @__PURE__ */ jsx8(
            "div",
            {
              className: "indicator",
          ...
          /* @__PURE__ */ jsx8(
            "div",
            {
              ...
              children: images.map((src, index) => /* @__PURE__ */ jsx8(
                "div",
                {
                  className: "item",
                  ref: (el) => {
        ...
        /* @__PURE__ */ jsx8("div", { className: "img-preview", style: { position: "fixed" }, children: /* @__PURE__ */ jsx8(
          "img",
          {
            ref: previewImageRef,
            src: images[0],
...
function SofiHealthScroll({
  ...
  const modelContainerRef = useRef9(null);
  const sceneRef = useRef9(null);
  const rendererRef = useRef9(null);
  const cameraRef = useRef9(null);
  const modelRef = useRef9(null);
  const currentRotationRef = useRef9(0);
  const modelSizeRef = useRef9(null);
  useEffect8(() => {
    if (typeof window === "undefined" || !modelContainerRef.current) return;
    gsap7.registerPlugin(ScrollTrigger7, SplitText);
    ...
    ScrollTrigger7.create({
      trigger: ".sofi-product-overview",
      start: "75% bottom",
      onEnter: () => gsap7.to(".sofi-header-1 h1 .char > span", {
        y: "0%",
        ...animOptions
      }),
      onLeaveBack: () => gsap7.to(".sofi-header-1 h1 .char > span", {
        y: "100%",
        ...animOptions
      })
    });
    ...
    return () => {
      window.removeEventListener("resize", handleResize);
      ScrollTrigger7.getAll().forEach((trigger) => trigger.kill());
  ...
  return /* @__PURE__ */ jsx9("div", { className: cn5("sofi-health-scroll", className), ref: containerRef, children: /* @__PURE__ */ jsxs7("div", { className: "sofi-product-overview", children: [
    ...
    /* @__PURE__ */ jsx9("div", { className: "sofi-circular-mask", children: /* @__PURE__ */ jsxs7("div", { className: "sofi-header-2", children: [
      /* @__PURE__ */ jsx9("h1", { children: headerTexts.header2 }),
      /* @__PURE__ */ jsx9("div", { className: "sofi-tooltips", children: tooltips.map((tooltip, index) => /* @__PURE__ */ jsxs7("div", { className: "sofi-tooltip", children: [
        /* @__PURE__ */ jsx9("div", { className: "icon", children: /* @__PURE__ */ jsx9("i", { className: `icon-${tooltip.icon}` }) }),
        /* @__PURE__ */ jsx9("div", { className: "divider" }),
        /* @__PURE__ */ jsxs7("div", { className: "content", children: [
          /* @__PURE__ */ jsx9("div", { className: "title", children: /* @__PURE__ */ jsx9("h2", { children: tooltip.title }) }),
          /* @__PURE__ */ jsx9("div", { className: "description", children: /* @__PURE__ */ jsx9("p", { children: tooltip.description }) })
        ] })
      ] }, index)) })
    ] }) })
  ] }) });
...
function TheFirstTheLastScroll({
  ...
  const cardRefs = useRef10([]);
  const defaultRotations = [-12, 10, -5, 5, -5, -2];
  useEffect9(() => {
    if (typeof window === "undefined" || !containerRef.current) return;
    gsap8.registerPlugin(ScrollTrigger8);
    ...
    const scrollTrigger = ScrollTrigger8.create({
      trigger: containerRef.current,
      start: "top top",
      end: `+=${window.innerHeight * pinHeight}px`,
      pin: true,
  ...
  return /* @__PURE__ */ jsx10("div", { className: cn6("the-first-the-last-scroll", className), children: /* @__PURE__ */ jsx10("div", { className: "sticky-cards", ref: containerRef, children: cards.map((card, index) => /* @__PURE__ */ jsx10(
    "div",
    {
      className: "card",
      ref: (el) => {
