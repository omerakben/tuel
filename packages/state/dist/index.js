...
__export(index_exports, {
  useAnimationLifecycle: () => useAnimationLifecycle,
...
function useAnimationSequence(steps, options = {}) {
  ...
  const previous = (0, import_react.useCallback)(async () => {
  ...
  const jumpTo = (0, import_react.useCallback)(
    async (stepName) => {
...
function useVariants(variants, options = {}) {
  ...
  const [variantState, setVariantState] = (0, import_react2.useState)({
    current: initial,
    previous: null,
    isTransitioning: false,
    history: [initial]
  });
  const transitionProgress = (0, import_framer_motion2.useMotionValue)(0);
  const isTransitioning = (0, import_react2.useRef)(false);
  const updateHistory = (0, import_react2.useCallback)(
    (variant, history) => {
  ...
  const setVariant = (0, import_react2.useCallback)(
    async (variantName) => {
  ...
  const cycle = (0, import_react2.useCallback)(
    async (variantNames) => {
...
function useAnimationLifecycle(timing = {}, events = {}) {
  ...
  const [lifecycleState, setLifecycleState] = (0, import_react3.useState)({
    phase: "idle",
    progress: 0,
    duration,
    elapsed: 0,
  ...
  const animationRef = (0, import_react3.useRef)(void 0);
  const startTimeRef = (0, import_react3.useRef)(void 0);
  const pausedTimeRef = (0, import_react3.useRef)(0);
  const updateState = (0, import_react3.useCallback)((updates) => {
    setLifecycleState((prev) => __spreadValues(__spreadValues({}, prev), updates));
  }, []);
  const easeFunction = (0, import_react3.useCallback)(
    (t) => {
